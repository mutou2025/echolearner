                ...
                <div className="flex w-full flex-col justify-center gap-4 bg-white px-2 pb-4 pt-5 dark:bg-gray-800 dark:text-gray-300">
                  ...
                  <div className="flex w-full flex-col gap-4 px-4">
                    <p className="mx-auto px-4 indent-4">
                      您刚刚完成了<HighlightedText> {chapterNumber} </HighlightedText>章节的练习，Echo Learner 已经陪你走过
                    ...
                    <p className="mx-auto px-4 indent-4">
                      Echo Learner 已经坚持 <span className="font-medium ">开放源码、无广告、无商业化</span> 运营
                      <HighlightedText className="text-indigo-500"> {dayFromQwerty} </HighlightedText> 天，
                      我们的目标是为所有学习者提供一个高效、便捷、无干扰的学习环境。我们诚挚地邀请您考虑进行捐赠，捐赠将直接用于维持 Echo Learner
                      的日常运营以及未来发展，让 Echo Learner 与您一起成长。
                    </p>
                    <p className="mx-auto px-4 indent-4 ">
                      为了感谢您的慷慨，单次 50 rmb 及以上的捐赠， 我们将回赠 Echo Learner 的定制贴纸 5 枚
