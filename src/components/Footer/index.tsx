    ...
    <>
      ...
      >
        <p className="indent-4 text-sm text-gray-500 dark:text-gray-300">
          非常感谢大家使用 Echo Learner，目前该网站使用业余时间在维护，为了保证网站能够持续地提供给大家高质量的服务，我们需要您的帮助！
          <br />
        ...
        <p className="indent-4 text-sm text-gray-700 dark:text-gray-200">
          我们相信，共同的努力可以让 Echo Learner 成为更好的学习平台，也相信您的支持将给予我们持续前进的动力。 感谢您的支持！
        </p>
        <br />
        <p className="indent-4 text-sm text-gray-700 dark:text-gray-200">
          为了感谢您的慷慨，单次 50 rmb 及以上的捐赠， 我们将回赠 Echo Learner 的定制贴纸 5 枚<span className="text-xs">（仅限大陆地区）</span>
          ，希望您可以跟朋友分享您的快乐
        </p>
      ...
      >
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Echo Learner 是一个开源项目，旨在为用户提供高质量、可靠的打字练习工具。
          <br />
      ...
      <footer className="mb-1 mt-4 flex w-full items-center justify-center gap-2.5 text-sm ease-in" onClick={(e) => e.currentTarget.blur()}>
        ...
        <button
          ...
          aria-label="使用 Visual Studio Code 插件版 Echo Learner"
        >
